        ...
        <div className="fixfont-family">
          ...
          <div className="mainVocher_left">
            <div className="list_anh">
              ...
              <img
                src="https://www.liffordstrabane.com/articleimages/gift-voucher-normal%20(1).gif"
                alt=""
              />
              <img
                src="https://static-sg.zacdn.com/cms/2021/CW48/BFCM/TEASERBANNER/SET1/Kids/DESKTOP_Hero.gif"
                alt=""
              />
            </div>
            <div className="title_Vocher">Game, Ứng dụng xem nhiều</div>
            <div className="item_app">
              {dataVocher.map((item, index) => (
                <ItemApp key={index} item={item} />
              ))}
            </div>
            <div className="title_Vocherx">Xem nhiều tuần qua</div>
